...
router.get("/getall", async (req, res) => {
  try {
    ...
    res.status(404).json("getAll went wrong");
  }
});
...
router.post("/", async (req, res) => {
  ...
  if (
    ...
    client.get("articlesBy_Date_Category_language", (err, data) => {
      if (data !== null) {
        ...
        const data1 = searchBy_Date_Category_language(
          startDate,
          endDate,
          category,
          language
        ...
        client.setex(
          "articlesBy_Date_Category_language",
          3600,
          JSON.stringify(data1)
        );
        res.status(200).json(data1);
  ...
  if (
    ...
    const data = searchBy_SearchTerm_Category_language(
      searchTerm,
      category,
      language
    );
  ...
  if (
    ...
    const data = searchBy_searchTerm_Date_Language(
      searchTerm,
      startDate,
      endDate,
      language
  ...
  if (
    ...
    const data = searchBy_searchTerm_Date_Category(
      searchTerm,
      endDate,
      startDate,
      category
  ...
  if (
    ...
    const data = searchBy_searchTerm_Date_Category_Language(
      searchTerm,
      category,
      language,
      endDate,
