...
const createCustomTopic = async (req, res) => {
  ...
  try {
    ...
    if (req.body.enddate != undefined)
      topicsFields.filters.enddate = req.body.enddate;
    if (req.body.startdate != undefined)
      topicsFields.filters.startdate = req.body.startdate;
    if (req.body.language != undefined)
      topicsFields.filters.language = req.body.language;
    if (req.body.engagement != undefined)
      topicsFields.filters.engagement = req.body.engagement; // ignore for now
...
const getCustomTopics = async (req, res) => {
  try {
    ...
    const customTopics = await customTopicSearchModel
      .find({ userId: userId })
      .cache({
        key: userId,
      });
...
const updateCustomTopic = async (req, res) => {
  try {
    ...
    if (req.body.language != undefined)
      topicsFields.filters.language = req.body.language;
    if (req.body.engagement != undefined)
      topicsFields.filters.engagement = req.body.engagement;
